    ...
    .then((result: any) => {
      if (result.shouldUpdate) {
        ...
        Alert.alert(
          ...
          "Uma nova versão crítica do aplicativo Elétrica Predial está disponível na loja. Precisamos atualizar para garantir as exigências da NBR 5410 e o funcionamento correto dos cálculos.",
          [
            {
